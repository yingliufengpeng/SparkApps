...
//     val sc = new SparkContext( conf )
       ...
       ssc.checkpoint( "resources/checkpoint" )
     /**
...
//     val lines = sc.textFile( "resources/README.md" )
     ...
     val hottestDStream = searchPairDStream.reduceByKeyAndWindow( ( v1 : Int  , v2 : Int  ) => v1 + v2 ,
         (  v1 : Int , v2 : Int ) => v1 - v2  , Seconds( 5 ) , Seconds( 2 ) )
