...
/**
  ...
  */
object FlumePushdata2SparkStreaming {
    def main(args: Array[String]) {
         ...
         */
        val conf = new SparkConf().setMaster( "local[4]" ).setAppName( "FlumePushdate2SparkStreaming" )
...
//        val lines = streamContext.socketTextStream( "Master" , 9999 )
        val lines = FlumeUtils.createStream( streamContext , "0.0.0.0" , 9999 )
